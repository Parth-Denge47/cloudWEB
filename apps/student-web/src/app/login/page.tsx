...
// Student login — Student ID + password per spec.
    ...
    <div className="flex min-h-screen flex-1 items-center justify-center bg-gradient-to-b from-brand-50 via-white to-white px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-lg font-semibold text-slate-900">LMS Student Panel</h1>
          <p className="mt-1 text-sm text-slate-500">Sign in with your Student ID</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm shadow-slate-900/[0.03]">
          ...
          <label className="mb-4 block">
            <span className="mb-1.5 block text-xs font-medium text-slate-600">Student ID</span>
          ...
          <p className="mt-4 text-center text-xs text-slate-400">
            Demo: ALL26010001 / ALL26010002 / ALL26010003 / ALL26020001 / PHY26030001 — any password
          </p>
        </form>
      </div>
    </div>
