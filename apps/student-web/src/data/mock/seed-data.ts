...
// In-memory seed data mirroring the same mock platform used by the Admin
// panel (same tuitions/teachers/students/ids) so the three panels feel
// like one consistent backend, even though each app runs against its own
// local mock repositories until a real API exists.
...
export const activityLogs = [
  { id: "act-1", message: "New student Aarav Singh registered", actorName: "Vikram Mehta", actorRole: "teacher" as const, tuitionId: "tui-1", timestamp: "2026-07-25T14:30:00.000Z" },
  { id: "act-2", message: "Uploaded library file: Organic Chemistry Reactions Cheat Sheet", actorName: "Neha Kapoor", actorRole: "teacher" as const, tuitionId: "tui-1", timestamp: "2026-07-25T11:10:00.000Z" },
  { id: "act-3", message: "Published quiz: Rotational Motion Test", actorName: "Rohit Saxena", actorRole: "teacher" as const, tuitionId: "tui-1", timestamp: "2026-07-24T16:45:00.000Z" },
];
