...
import { LayoutDashboard, Video, Library, FileQuestion, Award, Megaphone, GraduationCap } from "lucide-react";
...
// Independent navigation for the Student panel.
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-slate-100 bg-white lg:flex">
      <div className="flex items-center gap-2 px-6 py-5">
        ...
        <div>
          <p className="text-sm font-semibold text-slate-900">LMS Student</p>
          <p className="text-[11px] text-slate-400">Student Panel</p>
        </div>
      </div>
